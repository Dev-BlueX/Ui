local ui =  game:GetService("CoreGui"):FindFirstChild("redui") if ui then ui:Destroy() end
	...
	local PresetColor = Color3.fromRGB(30, 144, 255)
	...
	function create:Win(text)
		...
		MainSceen.BackgroundColor3 = Color3.fromRGB(70, 130, 180)
		...
		ClickFrame.BackgroundColor3 = Color3.fromRGB(135, 206, 250)
		...
		NameReal.TextColor3 = Color3.fromRGB(15,15,15)
		...
		MainSceen2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
		...
		NotiFrame.BackgroundColor3 = Color3.fromRGB(25, 25, 112)
...
for _, element in pairs({MainSceen, ClickFrame, NotiFrame}) do
